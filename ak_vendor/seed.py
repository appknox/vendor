...
analysis_template = {
    ...
    "findings": [
        {
            "title": None,
            "description": "This application opens a socket and connects to it, which might be insecured, defined at Lcom/e/a/a/a/q;->b",
        },
        {
            "title": None,
            "description": "This application opens a socket and connects to it, which might be insecured, defined at Lcom/e/a/a/a/p;->a",
        },
        {
            "title": None,
            "description": "This application opens a socket and connects to it, which might be insecured, defined at Lcom/e/a/a/a/p;->d",
        },
        {
            "title": None,
            "description": "This application opens a socket and connects to it, which might be insecured, defined at Lcom/e/a/a/a/p;->f",
        },
        {
            "title": "Debug was enabled on the app which make it easier for attackers to hook a debugger, dump a stack trace and access debugging helper classes.",
            "description": "<application android:debuggable='true' Debug enabled for app",
        },
    ],
    "risk": 3,
    "status": 1,
    ...
    "owasp_categories": [
        OWASP_DATA.get("M1_2016"),
        OWASP_DATA.get("M10_2016"),
...
file_data = {
    ...
    "risk_count_medium": 7,
    "risk_count_low": 8,
    "profile": {"report_preference": {"show_ignored_analyses": True}},
}
