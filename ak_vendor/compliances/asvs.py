...
data = [
  {
    "code": "V1.1.1",
    "id": "ASVS_1.1.1",
    "title": _("Verify the use of a secure software development lifecycle "
  ...
  },
  {
    ...
    "code": "V1.1.3",
    "id": "ASVS_1.1.3",
    "title": _("Verify that all user stories and features contain functional "
  ...
  },
  {
    ...
    "code": "V1.1.4",
    "id": "ASVS_1.1.4",
    "title": _("Verify documentation and justification of all the "
  ...
  },
  {
    ...
    "code": "V1.1.5",
    "id": "ASVS_1.1.5",
    "title": _("Verify definition and security analysis of the application's "
  ...
  },
  {
    ...
    "code": "V1.1.6",
    "id": "ASVS_1.1.6",
    "title": _("Verify implementation of centralized, simple (economy of "
  ...
  },
  {
    ...
    "code": "V1.1.7",
    "id": "ASVS_1.1.7",
    "title": _("Verify availability of a secure coding checklist, security "
  ...
  },
  {
    ...
    "code": "V1.10.1",
    "id": "ASVS_1.10.1",
    "title": _("Verify that a source code control system is in use, with "
  ...
  },
  {
    ...
    "code": "V1.11.1",
    "id": "ASVS_1.11.1",
    "title": _("Verify the definition and documentation of all application "
  ...
  },
  {
    ...
    "code": "V1.11.2",
    "id": "ASVS_1.11.2",
    "title": _("Verify that all high-value business logic flows, including "
  ...
  },
  {
    ...
    "code": "V1.12.1",
    "id": "ASVS_1.12.1",
    "title": _("Verify that user-uploaded files are stored outside of the web "
               "root."),
    "active": True,
  },
  {
    ...
    "code": "V1.12.2",
    "id": "ASVS_1.12.2",
    "title": _("Verify that user-uploaded files - if required to be displayed "
  ...
  },
  {
    ...
    "code": "V1.14.1",
    "id": "ASVS_1.14.1",
    "title": _("Verify the segregation of components of differing trust "
  ...
  },
  {
    ...
    "code": "V1.14.2",
    "id": "ASVS_1.14.2",
    "title": _("Verify that binary signatures, trusted connections, and "
  ...
  },
  {
    ...
    "code": "V1.14.3",
    "id": "ASVS_1.14.3",
    "title": _("Verify that the build pipeline warns of out-of-date or "
  ...
  },
  {
    ...
    "code": "V1.14.4",
    "id": "ASVS_1.14.4",
    "title": _("Verify that the build pipeline contains a build step to "
  ...
  },
  {
    ...
    "code": "V1.14.5",
    "id": "ASVS_1.14.5",
    "title": _("Verify that application deployments adequately sandbox, "
  ...
  },
  {
    ...
    "code": "V1.14.6",
    "id": "ASVS_1.14.6",
    "title": _("Verify the application does not use unsupported, insecure, or "
  ...
  },
  {
    ...
    "code": "V1.2.1",
    "id": "ASVS_1.2.1",
    "title": _("Verify the use of unique or special low-privilege operating "
  ...
  },
  {
    ...
    "code": "V1.2.2",
    "id": "ASVS_1.2.2",
    "title": _("Verify that communications between application components, "
  ...
  },
  {
    ...
    "code": "V1.2.3",
    "id": "ASVS_1.2.3",
    "title": _("Verify that the application uses a single vetted "
  ...
  },
  {
    ...
    "code": "V1.2.4",
    "id": "ASVS_1.2.4",
    "title": _("Verify that all authentication pathways and identity "
  ...
  },
  {
    ...
    "code": "V1.4.1",
    "id": "ASVS_1.4.1",
    "title": _("Verify that trusted enforcement points such as at access "
  ...
  },
  {
    ...
    "code": "V1.4.2",
    "id": "ASVS_1.4.2",
    "title": _("Verify that the chosen access control solution is flexible "
  ...
  },
  {
    ...
    "code": "V1.4.3",
    "id": "ASVS_1.4.3",
    "title": _("Verify enforcement of the principle of least privilege in "
  ...
  },
  {
    ...
    "code": "V1.4.4",
    "id": "ASVS_1.4.4",
    "title": _("Verify the application uses a single and well-vetted access "
  ...
  },
  {
    ...
    "code": "V1.4.5",
    "id": "ASVS_1.4.5",
    "title": _("Verify that attribute or feature-based access control is used "
  ...
  },
  {
    ...
    "code": "V1.5.1",
    "id": "ASVS_1.5.1",
    "title": _("Verify that input and output requirements clearly define how "
  ...
  },
  {
    ...
    "code": "V1.5.2",
    "id": "ASVS_1.5.2",
    "title": _("Verify that serialization is not used when communicating with "
  ...
  },
  {
    ...
    "code": "V1.5.3",
    "id": "ASVS_1.5.3",
    "title": _("Verify that input validation is enforced on a trusted service "
               "layer."),
    "active": True,
  },
  {
    ...
    "code": "V1.5.4",
    "id": "ASVS_1.5.4",
    "title": _("Verify that output encoding occurs close to or by the "
  ...
  },
  {
    ...
    "code": "V1.6.1",
    "id": "ASVS_1.6.1",
    "title": _("Verify that there is an explicit policy for management of "
  ...
  },
  {
    ...
    "code": "V1.6.2",
    "id": "ASVS_1.6.2",
    "title": _("Verify that consumers of cryptographic services protect key "
  ...
  },
  {
    ...
    "code": "V1.6.3",
    "id": "ASVS_1.6.3",
    "title": _("Verify that all keys and passwords are replaceable and are "
  ...
  },
  {
    ...
    "code": "V1.6.4",
    "id": "ASVS_1.6.4",
    "title": _("Verify that the architecture treats client-side secrets--such "
  ...
  },
  {
    ...
    "code": "V1.7.1",
    "id": "ASVS_1.7.1",
    "title": _("Verify that a common logging format and approach is used "
               "across the system."),
    "active": True,
  },
  {
    ...
    "code": "V1.7.2",
    "id": "ASVS_1.7.2",
    "title": _("Verify that logs are securely transmitted to a preferably "
  ...
  },
  {
    ...
    "code": "V1.8.1",
    "id": "ASVS_1.8.1",
    "title": _("Verify that all sensitive data is identified and classified "
  ...
  },
  {
    ...
    "code": "V1.8.2",
    "id": "ASVS_1.8.2",
    "title": _("Verify that all protection levels have an associated set of "
  ...
  },
  {
    ...
    "code": "V1.9.1",
    "id": "ASVS_1.9.1",
    "title": _("Verify the application encrypts communications between "
  ...
  },
  {
    ...
    "code": "V1.9.2",
    "id": "ASVS_1.9.2",
    "title": _("Verify that application components verify the authenticity of "
  ...
  },
  {
    ...
    "code": "V10.1.1",
    "id": "ASVS_10.1.1",
    "title": _("Verify that a code analysis tool is in use that can detect "
  ...
  },
  {
    ...
    "code": "V10.2.1",
    "id": "ASVS_10.2.1",
    "title": _("Verify that the application source code and third party "
  ...
  },
  {
    ...
    "code": "V10.2.2",
    "id": "ASVS_10.2.2",
    "title": _("Verify that the application does not ask for unnecessary or "
  ...
  },
  {
    ...
    "code": "V10.3.1",
    "id": "ASVS_10.3.1",
    "title": _("Verify that if the application has a client or server "
  ...
  },
  {
    ...
    "code": "V10.3.2",
    "id": "ASVS_10.3.2",
    "title": _("Verify that the application employs integrity protections, "
  ...
  },
  {
    ...
    "code": "V10.3.3",
    "id": "ASVS_10.3.3",
    "title": _("Verify that the application has protection from subdomain "
  ...
  },
  {
    ...
    "code": "V11.1.1",
    "id": "ASVS_11.1.1",
    "title": _("Verify the application will only process business logic flows "
  ...
  },
  {
    ...
    "code": "V11.1.3",
    "id": "ASVS_11.1.3",
    "title": _("Verify the application has appropriate limits for specific "
  ...
  },
  {
    ...
    "code": "V11.1.4",
    "id": "ASVS_11.1.4",
    "title": _("Verify the application has sufficient anti-automation "
  ...
  },
  {
    ...
    "code": "V11.1.5",
    "id": "ASVS_11.1.5",
    "title": _("Verify the application has business logic limits or "
  ...
  },
  {
    ...
    "code": "V11.1.6",
    "id": "ASVS_11.1.6",
    "title": _("Verify the application does not suffer from \"Time Of Check "
  ...
  },
  {
    ...
    "code": "V11.1.7",
    "id": "ASVS_11.1.7",
    "title": _("Verify the application monitors for unusual events or "
  ...
  },
  {
    ...
    "code": "V11.1.8",
    "id": "ASVS_11.1.8",
    "title": _("Verify the application has configurable alerting when "
  ...
  },
  {
    ...
    "code": "V12.1.1",
    "id": "ASVS_12.1.1",
    "title": _("Verify that the application will not accept large files that "
  ...
  },
  {
    ...
    "code": "V12.1.2",
    "id": "ASVS_12.1.2",
    "title": _("Verify that compressed files are checked for \"zip bombs\" - "
  ...
  },
  {
    ...
    "code": "V12.1.3",
    "id": "ASVS_12.1.3",
    "title": _("Verify that a file size quota and maximum number of files per "
  ...
  },
  {
    ...
    "code": "V12.2.1",
    "id": "ASVS_12.2.1",
    "title": _("Verify that files obtained from untrusted sources are "
  ...
  },
  {
    ...
    "code": "V12.3.1",
    "id": "ASVS_12.3.1",
    "title": _("Verify that user-submitted filename metadata is not used "
  ...
  },
  {
    ...
    "code": "V12.3.2",
    "id": "ASVS_12.3.2",
    "title": _("Verify that user-submitted filename metadata is validated or "
  ...
  },
  {
    ...
    "code": "V12.3.4",
    "id": "ASVS_12.3.4",
    "title": _("Verify that the application protects against Reflective File "
  ...
  },
  {
    ...
    "code": "V12.3.5",
    "id": "ASVS_12.3.5",
    "title": _("Verify that untrusted file metadata is not used directly with "
  ...
  },
  {
    ...
    "code": "V12.3.6",
    "id": "ASVS_12.3.6",
    "title": _("Verify that the application does not include and execute "
  ...
  },
  {
    ...
    "code": "V12.4.1",
    "id": "ASVS_12.4.1",
    "title": _("Verify that files obtained from untrusted sources are stored "
  ...
  },
  {
    ...
    "code": "V12.4.2",
    "id": "ASVS_12.4.2",
    "title": _("Verify that files obtained from untrusted sources are scanned "
  ...
  },
  {
    ...
    "code": "V12.5.1",
    "id": "ASVS_12.5.1",
    "title": _("Verify that the web tier is configured to serve only files "
  ...
  },
  {
    ...
    "code": "V12.5.2",
    "id": "ASVS_12.5.2",
    "title": _("Verify that direct requests to uploaded files will never be "
  ...
  },
  {
    ...
    "code": "V12.6.1",
    "id": "ASVS_12.6.1",
    "title": _("Verify that the web or application server is configured with "
  ...
  },
  {
    ...
    "code": "V13.1.1",
    "id": "ASVS_13.1.1",
    "title": _("Verify that all application components use the same encodings "
  ...
  },
  {
    ...
    "code": "V13.1.2",
    "id": "ASVS_13.1.2",
    "title": _("Verify that access to administration and management functions "
  ...
  },
  {
    ...
    "code": "V13.1.3",
    "id": "ASVS_13.1.3",
    "title": _("Verify API URLs do not expose sensitive information, such as "
  ...
  },
  {
    ...
    "code": "V13.1.4",
    "id": "ASVS_13.1.4",
    "title": _("Verify that authorization decisions are made at both the URI, "
  ...
  },
  {
    ...
    "code": "V13.1.5",
    "id": "ASVS_13.1.5",
    "title": _("Verify that requests containing unexpected or missing content "
  ...
  },
  {
    ...
    "code": "V13.2.1",
    "id": "ASVS_13.2.1",
    "title": _("Verify that enabled RESTful HTTP methods are a valid choice "
  ...
  },
  {
    ...
    "code": "V13.2.2",
    "id": "ASVS_13.2.2",
    "title": _("Verify that JSON schema validation is in place and verified "
  ...
  },
  {
    ...
    "code": "V13.2.3",
    "id": "ASVS_13.2.3",
    "title": _("Verify that RESTful web services that utilize cookies are "
  ...
  },
  {
    ...
    "code": "V13.2.4",
    "id": "ASVS_13.2.4",
    "title": _("Verify that REST services have anti-automation controls to "
  ...
  },
  {
    ...
    "code": "V13.2.5",
    "id": "ASVS_13.2.5",
    "title": _("Verify that REST services explicitly check the incoming "
  ...
  },
  {
    ...
    "code": "V13.2.6",
    "id": "ASVS_13.2.6",
    "title": _("Verify that the message headers and payload are trustworthy "
  ...
  },
  {
    ...
    "code": "V13.3.1",
    "id": "ASVS_13.3.1",
    "title": _("Verify that XSD schema validation takes place to ensure a "
  ...
  },
  {
    ...
    "code": "V13.3.2",
    "id": "ASVS_13.3.2",
    "title": _("Verify that the message payload is signed using WS-Security "
  ...
  },
  {
    ...
    "code": "V13.4.1",
    "id": "ASVS_13.4.1",
    "title": _("Verify that a query allow list or a combination of depth "
  ...
  },
  {
    ...
    "code": "V13.4.2",
    "id": "ASVS_13.4.2",
    "title": _("Verify that GraphQL or other data layer authorization logic "
  ...
  },
  {
    ...
    "code": "V14.1.1",
    "id": "ASVS_14.1.1",
    "title": _("Verify that the application build and deployment processes "
  ...
  },
  {
    ...
    "code": "V14.1.2",
    "id": "ASVS_14.1.2",
    "title": _("Verify that compiler flags are configured to enable all "
  ...
  },
  {
    ...
    "code": "V14.1.3",
    "id": "ASVS_14.1.3",
    "title": _("Verify that server configuration is hardened as per the "
  ...
  },
  {
    ...
    "code": "V14.1.4",
    "id": "ASVS_14.1.4",
    "title": _("Verify that the application, configuration, and all "
  ...
  },
  {
    ...
    "code": "V14.1.5",
    "id": "ASVS_14.1.5",
    "title": _("Verify that authorized administrators can verify the "
  ...
  },
  {
    ...
    "code": "V14.2.1",
    "id": "ASVS_14.2.1",
    "title": _("Verify that all components are up to date, preferably using a "
  ...
  },
  {
    ...
    "code": "V14.2.2",
    "id": "ASVS_14.2.2",
    "title": _("Verify that all unneeded features, documentation, samples, "
  ...
  },
  {
    ...
    "code": "V14.2.3",
    "id": "ASVS_14.2.3",
    "title": _("Verify that if application assets, such as JavaScript "
  ...
  },
  {
    ...
    "code": "V14.2.4",
    "id": "ASVS_14.2.4",
    "title": _("Verify that third party components come from pre-defined, "
  ...
  },
  {
    ...
    "code": "V14.2.5",
    "id": "ASVS_14.2.5",
    "title": _("Verify that an inventory catalog is maintained of all third "
  ...
  },
  {
    ...
    "code": "V14.2.6",
    "id": "ASVS_14.2.6",
    "title": _("Verify that the attack surface is reduced by sandboxing or "
  ...
  },
  {
    ...
    "code": "V14.3.1",
    "id": "ASVS_14.3.1",
    "title": _("Verify that web or application server and framework error "
  ...
  },
  {
    ...
    "code": "V14.3.2",
    "id": "ASVS_14.3.2",
    "title": _("Verify that web or application server and application "
  ...
  },
  {
    ...
    "code": "V14.3.3",
    "id": "ASVS_14.3.3",
    "title": _("Verify that the HTTP headers or any part of the HTTP response "
  ...
  },
  {
    ...
    "code": "V14.4.1",
    "id": "ASVS_14.4.1",
    "title": _("Verify that every HTTP response contains a Content-Type "
  ...
  },
  {
    ...
    "code": "V14.4.2",
    "id": "ASVS_14.4.2",
    "title": _("Verify that all API responses contain a Content-Disposition: "
  ...
  },
  {
    ...
    "code": "V14.4.3",
    "id": "ASVS_14.4.3",
    "title": _("Verify that a Content Security Policy (CSP) response header "
  ...
  },
  {
    ...
    "code": "V14.4.4",
    "id": "ASVS_14.4.4",
    "title": _("Verify that all responses contain a X-Content-Type-Options: "
               "nosniff header."),
    "active": True,
  },
  {
    ...
    "code": "V14.4.5",
    "id": "ASVS_14.4.5",
    "title": _("Verify that a Strict-Transport-Security header is included on "
  ...
  },
  {
    ...
    "code": "V14.4.6",
    "id": "ASVS_14.4.6",
    "title": _("Verify that a suitable \"Referrer-Policy\" header is "
  ...
  },
  {
    ...
    "code": "V14.4.7",
    "id": "ASVS_14.4.7",
    "title": _("Verify that the content of a web application cannot be "
  ...
  },
  {
    ...
    "code": "V14.5.1",
    "id": "ASVS_14.5.1",
    "title": _("Verify that the application server only accepts the HTTP "
  ...
  },
  {
    ...
    "code": "V14.5.2",
    "id": "ASVS_14.5.2",
    "title": _("Verify that the supplied Origin header is not used for "
  ...
  },
  {
    ...
    "code": "V14.5.3",
    "id": "ASVS_14.5.3",
    "title": _("Verify that the Cross-Origin Resource Sharing (CORS) "
  ...
  },
  {
    ...
    "code": "V14.5.4",
    "id": "ASVS_14.5.4",
    "title": _("Verify that HTTP headers added by a trusted proxy or SSO "
  ...
  },
  {
    ...
    "code": "V2.1.1",
    "id": "ASVS_2.1.1",
    "title": _("Verify that user set passwords are at least 12 characters in "
  ...
  },
  {
    ...
    "code": "V2.1.10",
    "id": "ASVS_2.1.10",
    "title": _("Verify that there are no periodic credential rotation or "
  ...
  },
  {
    ...
    "code": "V2.1.11",
    "id": "ASVS_2.1.11",
    "title": _("Verify that \"paste\" functionality, browser password "
  ...
  },
  {
    ...
    "code": "V2.1.12",
    "id": "ASVS_2.1.12",
    "title": _("Verify that the user can choose to either temporarily view "
  ...
  },
  {
    ...
    "code": "V2.1.2",
    "id": "ASVS_2.1.2",
    "title": _("Verify that passwords 64 characters or longer are permitted "
  ...
  },
  {
    ...
    "code": "V2.1.3",
    "id": "ASVS_2.1.3",
    "title": _("Verify that password truncation is not performed. However, "
  ...
  },
  {
    ...
    "code": "V2.1.4",
    "id": "ASVS_2.1.4",
    "title": _("Verify that any printable Unicode character, including "
  ...
  },
  {
    ...
    "code": "V2.1.6",
    "id": "ASVS_2.1.6",
    "title": _("Verify that password change functionality requires the user's "
  ...
  },
  {
    ...
    "code": "V2.1.7",
    "id": "ASVS_2.1.7",
    "title": _("Verify that passwords submitted during account registration, "
  ...
  },
  {
    ...
    "code": "V2.1.8",
    "id": "ASVS_2.1.8",
    "title": _("Verify that a password strength meter is provided to help "
  ...
  },
  {
    ...
    "code": "V2.1.9",
    "id": "ASVS_2.1.9",
    "title": _("Verify that there are no password composition rules limiting "
  ...
  },
  {
    ...
    "code": "V2.10.1",
    "id": "ASVS_2.10.1",
    "title": _("Verify that intra-service secrets do not rely on unchanging "
  ...
  },
  {
    ...
    "code": "V2.10.2",
    "id": "ASVS_2.10.2",
    "title": _("Verify that if passwords are required for service "
  ...
  },
  {
    ...
    "code": "V2.10.3",
    "id": "ASVS_2.10.3",
    "title": _("Verify that passwords are stored with sufficient protection "
  ...
  },
  {
    ...
    "code": "V2.10.4",
    "id": "ASVS_2.10.4",
    "title": _("Verify passwords, integrations with databases and third-party "
  ...
  },
  {
    ...
    "code": "V2.2.1",
    "id": "ASVS_2.2.1",
    "title": _("Verify that anti-automation controls are effective at "
  ...
  },
  {
    ...
    "code": "V2.2.2",
    "id": "ASVS_2.2.2",
    "title": _("Verify that the use of weak authenticators (such as SMS and "
  ...
  },
  {
    ...
    "code": "V2.2.3",
    "id": "ASVS_2.2.3",
    "title": _("Verify that secure notifications are sent to users after "
  ...
  },
  {
    ...
    "code": "V2.2.4",
    "id": "ASVS_2.2.4",
    "title": _("Verify impersonation resistance against phishing, such as the "
  ...
  },
  {
    ...
    "code": "V2.2.5",
    "id": "ASVS_2.2.5",
    "title": _("Verify that where a Credential Service Provider (CSP) and the "
  ...
  },
  {
    ...
    "code": "V2.2.6",
    "id": "ASVS_2.2.6",
    "title": _("Verify replay resistance through the mandated use of One-time "
  ...
  },
  {
    ...
    "code": "V2.2.7",
    "id": "ASVS_2.2.7",
    "title": _("Verify intent to authenticate by requiring the entry of an "
  ...
  },
  {
    ...
    "code": "V2.3.1",
    "id": "ASVS_2.3.1",
    "title": _("Verify system generated initial passwords or activation codes "
  ...
  },
  {
    ...
    "code": "V2.3.2",
    "id": "ASVS_2.3.2",
    "title": _("Verify that enrollment and use of subscriber-provided "
  ...
  },
  {
    ...
    "code": "V2.3.3",
    "id": "ASVS_2.3.3",
    "title": _("Verify that renewal instructions are sent with sufficient "
  ...
  },
  {
    ...
    "code": "V2.4.1",
    "id": "ASVS_2.4.1",
    "title": _("Verify that passwords are stored in a form that is resistant "
  ...
  },
  {
    ...
    "code": "V2.4.2",
    "id": "ASVS_2.4.2",
    "title": _("Verify that the salt is at least 32 bits in length and be "
  ...
  },
  {
    ...
    "code": "V2.4.3",
    "id": "ASVS_2.4.3",
    "title": _("Verify that if PBKDF2 is used, the iteration count SHOULD be "
  ...
  },
  {
    ...
    "code": "V2.4.4",
    "id": "ASVS_2.4.4",
    "title": _("Verify that if bcrypt is used, the work factor SHOULD be as "
  ...
  },
  {
    ...
    "code": "V2.4.5",
    "id": "ASVS_2.4.5",
    "title": _("Verify that an additional iteration of a key derivation "
  ...
  },
  {
    ...
    "code": "V2.5.1",
    "id": "ASVS_2.5.1",
    "title": _("Verify that a system generated initial activation or recovery "
  ...
  },
  {
    ...
    "code": "V2.5.2",
    "id": "ASVS_2.5.2",
    "title": _("Verify password hints or knowledge-based authentication "
  ...
  },
  {
    ...
    "code": "V2.5.3",
    "id": "ASVS_2.5.3",
    "title": _("Verify password credential recovery does not reveal the "
  ...
  },
  {
    ...
    "code": "V2.5.4",
    "id": "ASVS_2.5.4",
    "title": _("Verify shared or default accounts are not present (e.g. "
               "\"root\", \"admin\", or \"sa\")."),
    "active": True,
  },
  {
    ...
    "code": "V2.5.5",
    "id": "ASVS_2.5.5",
    "title": _("Verify that if an authentication factor is changed or "
  ...
  },
  {
    ...
    "code": "V2.5.6",
    "id": "ASVS_2.5.6",
    "title": _("Verify forgotten password, and other recovery paths use a "
  ...
  },
  {
    ...
    "code": "V2.5.7",
    "id": "ASVS_2.5.7",
    "title": _("Verify that if OTP or multi-factor authentication factors are "
  ...
  },
  {
    ...
    "code": "V2.6.2",
    "id": "ASVS_2.6.2",
    "title": _("Verify that lookup secrets have sufficient randomness (112 "
  ...
  },
  {
    ...
    "code": "V2.6.3",
    "id": "ASVS_2.6.3",
    "title": _("Verify that lookup secrets are resistant to offline attacks, "
  ...
  },
  {
    ...
    "code": "V2.7.1",
    "id": "ASVS_2.7.1",
    "title": _("Verify that clear text out of band (NIST \"restricted\") "
  ...
  },
  {
    ...
    "code": "V2.7.2",
    "id": "ASVS_2.7.2",
    "title": _("Verify that the out of band verifier expires out of band "
  ...
  },
  {
    ...
    "code": "V2.7.3",
    "id": "ASVS_2.7.3",
    "title": _("Verify that the out of band verifier authentication requests, "
  ...
  },
  {
    ...
    "code": "V2.7.4",
    "id": "ASVS_2.7.4",
    "title": _("Verify that the out of band authenticator and verifier "
  ...
  },
  {
    ...
    "code": "V2.7.5",
    "id": "ASVS_2.7.5",
    "title": _("Verify that the out of band verifier retains only a hashed "
  ...
  },
  {
    ...
    "code": "V2.7.6",
    "id": "ASVS_2.7.6",
    "title": _("Verify that the initial authentication code is generated by a "
  ...
  },
  {
    ...
    "code": "V2.8.1",
    "id": "ASVS_2.8.1",
    "title": _("Verify that time-based OTPs have a defined lifetime before "
               "expiring."),
    "active": True,
  },
  {
    ...
    "code": "V2.8.2",
    "id": "ASVS_2.8.2",
    "title": _("Verify that symmetric keys used to verify submitted OTPs are "
  ...
  },
  {
    ...
    "code": "V2.8.3",
    "id": "ASVS_2.8.3",
    "title": _("Verify that approved cryptographic algorithms are used in the "
  ...
  },
  {
    ...
    "code": "V2.8.4",
    "id": "ASVS_2.8.4",
    "title": _("Verify that time-based OTP can be used only once within the "
               "validity period."),
    "active": True,
  },
  {
    ...
    "code": "V2.8.5",
    "id": "ASVS_2.8.5",
    "title": _("Verify that if a time-based multi-factor OTP token is re-used "
  ...
  },
  {
    ...
    "code": "V2.8.6",
    "id": "ASVS_2.8.6",
    "title": _("Verify physical single-factor OTP generator can be revoked in "
  ...
  },
  {
    ...
    "code": "V2.8.7",
    "id": "ASVS_2.8.7",
    "title": _("Verify that biometric authenticators are limited to use only "
  ...
  },
  {
    ...
    "code": "V2.9.1",
    "id": "ASVS_2.9.1",
    "title": _("Verify that cryptographic keys used in verification are "
  ...
  },
  {
    ...
    "code": "V2.9.2",
    "id": "ASVS_2.9.2",
    "title": _("Verify that the challenge nonce is at least 64 bits in "
  ...
  },
  {
    ...
    "code": "V3.1.1",
    "id": "ASVS_3.1.1",
    "title": _("Verify the application never reveals session tokens in URL "
               "parameters."),
    "active": True,
  },
  {
    ...
    "code": "V3.2.1",
    "id": "ASVS_3.2.1",
    "title": _("Verify the application generates a new session token on user "
               "authentication."),
    "active": True,
  },
  {
    ...
    "code": "V3.2.2",
    "id": "ASVS_3.2.2",
    "title": _("Verify that session tokens possess at least 64 bits of "
               "entropy."),
    "active": True,
  },
  {
    ...
    "code": "V3.2.3",
    "id": "ASVS_3.2.3",
    "title": _("Verify the application only stores session tokens in the "
  ...
  },
  {
    ...
    "code": "V3.2.4",
    "id": "ASVS_3.2.4",
    "title": _("Verify that session token are generated using approved "
  ...
  },
  {
    ...
    "code": "V3.3.1",
    "id": "ASVS_3.3.1",
    "title": _("Verify that logout and expiration invalidate the session "
  ...
  },
  {
    ...
    "code": "V3.3.2",
    "id": "ASVS_3.3.2",
    "title": _("If authenticators permit users to remain logged in, verify "
  ...
  },
  {
    ...
    "code": "V3.3.3",
    "id": "ASVS_3.3.3",
    "title": _("Verify that the application gives the option to terminate all "
  ...
  },
  {
    ...
    "code": "V3.3.4",
    "id": "ASVS_3.3.4",
    "title": _("Verify that users are able to view and (having re-entered "
  ...
  },
  {
    ...
    "code": "V3.4.1",
    "id": "ASVS_3.4.1",
    "title": _("Verify that cookie-based session tokens have the 'Secure' "
               "attribute set."),
    "active": True,
  },
  {
    ...
    "code": "V3.4.2",
    "id": "ASVS_3.4.2",
    "title": _("Verify that cookie-based session tokens have the 'HttpOnly' "
               "attribute set."),
    "active": True,
  },
  {
    ...
    "code": "V3.4.3",
    "id": "ASVS_3.4.3",
    "title": _("Verify that cookie-based session tokens utilize the "
  ...
  },
  {
    ...
    "code": "V3.4.4",
    "id": "ASVS_3.4.4",
    "title": _("Verify that cookie-based session tokens use \"__Host-\" "
  ...
  },
  {
    ...
    "code": "V3.4.5",
    "id": "ASVS_3.4.5",
    "title": _("Verify that if the application is published under a domain "
  ...
  },
  {
    ...
    "code": "V3.5.1",
    "id": "ASVS_3.5.1",
    "title": _("Verify the application allows users to revoke OAuth tokens "
  ...
  },
  {
    ...
    "code": "V3.5.2",
    "id": "ASVS_3.5.2",
    "title": _("Verify the application uses session tokens rather than static "
  ...
  },
  {
    ...
    "code": "V3.5.3",
    "id": "ASVS_3.5.3",
    "title": _("Verify that stateless session tokens use digital signatures, "
  ...
  },
  {
    ...
    "code": "V3.6.1",
    "id": "ASVS_3.6.1",
    "title": _("Verify that relying parties specify the maximum "
  ...
  },
  {
    ...
    "code": "V3.6.2",
    "id": "ASVS_3.6.2",
    "title": _("Verify that Credential Service Providers (CSPs) inform "
  ...
  },
  {
    ...
    "code": "V3.7.1",
    "id": "ASVS_3.7.1",
    "title": _("Verify the application ensures a full, valid login session or "
  ...
  },
  {
    ...
    "code": "V4.1.1",
    "id": "ASVS_4.1.1",
    "title": _("Verify that the application enforces access control rules on "
  ...
  },
  {
    ...
    "code": "V4.1.2",
    "id": "ASVS_4.1.2",
    "title": _("Verify that all user and data attributes and policy "
  ...
  },
  {
    ...
    "code": "V4.1.3",
    "id": "ASVS_4.1.3",
    "title": _("Verify that the principle of least privilege exists - users "
  ...
  },
  {
    ...
    "code": "V4.1.4",
    "id": "ASVS_4.1.4",
    "title": _("Verify that the principle of deny by default exists whereby "
  ...
  },
  {
    ...
    "code": "V4.1.5",
    "id": "ASVS_4.1.5",
    "title": _("Verify that access controls fail securely including when an "
               "exception occurs."),
    "active": True,
  },
  {
    ...
    "code": "V4.2.1",
    "id": "ASVS_4.2.1",
    "title": _("Verify that sensitive data and APIs are protected against "
  ...
  },
  {
    ...
    "code": "V4.2.2",
    "id": "ASVS_4.2.2",
    "title": _("Verify that the application or framework enforces a strong "
  ...
  },
  {
    ...
    "code": "V4.3.1",
    "id": "ASVS_4.3.1",
    "title": _("Verify administrative interfaces use appropriate multi-factor "
  ...
  },
  {
    ...
    "code": "V4.3.2",
    "id": "ASVS_4.3.2",
    "title": _("Verify that directory browsing is disabled unless "
  ...
  },
  {
    ...
    "code": "V4.3.3",
    "id": "ASVS_4.3.3",
    "title": _("Verify the application has additional authorization (such as "
  ...
  },
  {
    ...
    "code": "V5.1.1",
    "id": "ASVS_5.1.1",
    "title": _("Verify that the application has defenses against HTTP "
  ...
  },
  {
    ...
    "code": "V5.1.2",
    "id": "ASVS_5.1.2",
    "title": _("Verify that frameworks protect against mass parameter "
  ...
  },
  {
    ...
    "code": "V5.1.3",
    "id": "ASVS_5.1.3",
    "title": _("Verify that all input (HTML form fields, REST requests, URL "
  ...
  },
  {
    ...
    "code": "V5.1.4",
    "id": "ASVS_5.1.4",
    "title": _("Verify that structured data is strongly typed and validated "
  ...
  },
  {
    ...
    "code": "V5.1.5",
    "id": "ASVS_5.1.5",
    "title": _("Verify that URL redirects and forwards only allow "
  ...
  },
  {
    ...
    "code": "V5.2.1",
    "id": "ASVS_5.2.1",
    "title": _("Verify that all untrusted HTML input from WYSIWYG editors or "
  ...
  },
  {
    ...
    "code": "V5.2.2",
    "id": "ASVS_5.2.2",
    "title": _("Verify that unstructured data is sanitized to enforce safety "
  ...
  },
  {
    ...
    "code": "V5.2.3",
    "id": "ASVS_5.2.3",
    "title": _("Verify that the application sanitizes user input before "
  ...
  },
  {
    ...
    "code": "V5.2.4",
    "id": "ASVS_5.2.4",
    "title": _("Verify that the application avoids the use of eval() or other "
  ...
  },
  {
    ...
    "code": "V5.2.5",
    "id": "ASVS_5.2.5",
    "title": _("Verify that the application protects against template "
  ...
  },
  {
    ...
    "code": "V5.2.6",
    "id": "ASVS_5.2.6",
    "title": _("Verify that the application protects against SSRF attacks, by "
  ...
  },
  {
    ...
    "code": "V5.2.7",
    "id": "ASVS_5.2.7",
    "title": _("Verify that the application sanitizes, disables, or sandboxes "
  ...
  },
  {
    ...
    "code": "V5.3.1",
    "id": "ASVS_5.3.1",
    "title": _("Verify that output encoding is relevant for the interpreter "
  ...
  },
  {
    ...
    "code": "V5.3.10",
    "id": "ASVS_5.3.10",
    "title": _("Verify that the application protects against XPath injection "
  ...
  },
  {
    ...
    "code": "V5.3.2",
    "id": "ASVS_5.3.2",
    "title": _("Verify that output encoding preserves the user's chosen "
  ...
  },
  {
    ...
    "code": "V5.3.3",
    "id": "ASVS_5.3.3",
    "title": _("Verify that context-aware, preferably automated - or at "
  ...
  },
  {
    ...
    "code": "V5.3.4",
    "id": "ASVS_5.3.4",
    "title": _("Verify that data selection or database queries (e.g. SQL, "
  ...
  },
  {
    ...
    "code": "V5.3.5",
    "id": "ASVS_5.3.5",
    "title": _("Verify that where parameterized or safer mechanisms are not "
  ...
  },
  {
    ...
    "code": "V5.3.6",
    "id": "ASVS_5.3.6",
    "title": _("Verify that the application protects against JavaScript or "
  ...
  },
  {
    ...
    "code": "V5.3.7",
    "id": "ASVS_5.3.7",
    "title": _("Verify that the application protects against LDAP injection "
  ...
  },
  {
    ...
    "code": "V5.3.8",
    "id": "ASVS_5.3.8",
    "title": _("Verify that the application protects against OS command "
  ...
  },
  {
    ...
    "code": "V5.3.9",
    "id": "ASVS_5.3.9",
    "title": _("Verify that the application protects against Local File "
  ...
  },
  {
    ...
    "code": "V5.4.1",
    "id": "ASVS_5.4.1",
    "title": _("Verify that the application uses memory-safe string, safer "
  ...
  },
  {
    ...
    "code": "V5.4.2",
    "id": "ASVS_5.4.2",
    "title": _("Verify that format strings do not take potentially hostile "
  ...
  },
  {
    ...
    "code": "V5.4.3",
    "id": "ASVS_5.4.3",
    "title": _("Verify that sign, range, and input validation techniques are "
  ...
  },
  {
    ...
    "code": "V5.5.1",
    "id": "ASVS_5.5.1",
    "title": _("Verify that serialized objects use integrity checks or are "
  ...
  },
  {
    ...
    "code": "V5.5.2",
    "id": "ASVS_5.5.2",
    "title": _("Verify that the application correctly restricts XML parsers "
  ...
  },
  {
    ...
    "code": "V5.5.3",
    "id": "ASVS_5.5.3",
    "title": _("Verify that deserialization of untrusted data is avoided or "
  ...
  },
  {
    ...
    "code": "V5.5.4",
    "id": "ASVS_5.5.4",
    "title": _("Verify that when parsing JSON in browsers or JavaScript-based "
  ...
  },
  {
    ...
    "code": "V6.1.1",
    "id": "ASVS_6.1.1",
    "title": _("Verify that regulated private data is stored encrypted while "
  ...
  },
  {
    ...
    "code": "V6.1.2",
    "id": "ASVS_6.1.2",
    "title": _("Verify that regulated health data is stored encrypted while "
  ...
  },
  {
    ...
    "code": "V6.1.3",
    "id": "ASVS_6.1.3",
    "title": _("Verify that regulated financial data is stored encrypted "
  ...
  },
  {
    ...
    "code": "V6.2.1",
    "id": "ASVS_6.2.1",
    "title": _("Verify that all cryptographic modules fail securely, and "
  ...
  },
  {
    ...
    "code": "V6.2.2",
    "id": "ASVS_6.2.2",
    "title": _("Verify that industry proven or government approved "
  ...
  },
  {
    ...
    "code": "V6.2.3",
    "id": "ASVS_6.2.3",
    "title": _("Verify that encryption initialization vector, cipher "
  ...
  },
  {
    ...
    "code": "V6.2.4",
    "id": "ASVS_6.2.4",
    "title": _("Verify that random number, encryption or hashing algorithms, "
  ...
  },
  {
    ...
    "code": "V6.2.5",
    "id": "ASVS_6.2.5",
    "title": _("Verify that known insecure block modes (i.e. ECB, etc.), "
  ...
  },
  {
    ...
    "code": "V6.2.6",
    "id": "ASVS_6.2.6",
    "title": _("Verify that nonces, initialization vectors, and other single "
  ...
  },
  {
    ...
    "code": "V6.2.7",
    "id": "ASVS_6.2.7",
    "title": _("Verify that encrypted data is authenticated via signatures, "
  ...
  },
  {
    ...
    "code": "V6.2.8",
    "id": "ASVS_6.2.8",
    "title": _("Verify that all cryptographic operations are constant-time, "
  ...
  },
  {
    ...
    "code": "V6.3.1",
    "id": "ASVS_6.3.1",
    "title": _("Verify that all random numbers, random file names, random "
  ...
  },
  {
    ...
    "code": "V6.3.2",
    "id": "ASVS_6.3.2",
    "title": _("Verify that random GUIDs are created using the GUID v4 "
  ...
  },
  {
    ...
    "code": "V6.3.3",
    "id": "ASVS_6.3.3",
    "title": _("Verify that random numbers are created with proper entropy "
  ...
  },
  {
    ...
    "code": "V6.4.1",
    "id": "ASVS_6.4.1",
    "title": _("Verify that a secrets management solution such as a key vault "
  ...
  },
  {
    ...
    "code": "V6.4.2",
    "id": "ASVS_6.4.2",
    "title": _("Verify that key material is not exposed to the application "
  ...
  },
  {
    ...
    "code": "V7.1.1",
    "id": "ASVS_7.1.1",
    "title": _("Verify that the application does not log credentials or "
  ...
  },
  {
    ...
    "code": "V7.1.2",
    "id": "ASVS_7.1.2",
    "title": _("Verify that the application does not log other sensitive data "
  ...
  },
  {
    ...
    "code": "V7.1.3",
    "id": "ASVS_7.1.3",
    "title": _("Verify that the application logs security relevant events "
  ...
  },
  {
    ...
    "code": "V7.1.4",
    "id": "ASVS_7.1.4",
    "title": _("Verify that each log event includes necessary information "
  ...
  },
  {
    ...
    "code": "V7.2.1",
    "id": "ASVS_7.2.1",
    "title": _("Verify that all authentication decisions are logged, without "
  ...
  },
  {
    ...
    "code": "V7.2.2",
    "id": "ASVS_7.2.2",
    "title": _("Verify that all access control decisions can be logged and "
  ...
  },
  {
    ...
    "code": "V7.3.1",
    "id": "ASVS_7.3.1",
    "title": _("Verify that the application appropriately encodes "
  ...
  },
  {
    ...
    "code": "V7.3.2",
    "id": "ASVS_7.3.2",
    "title": _("Verify that all events are protected from injection when "
  ...
  },
  {
    ...
    "code": "V7.3.3",
    "id": "ASVS_7.3.3",
    "title": _("Verify that security logs are protected from unauthorized "
  ...
  },
  {
    ...
    "code": "V7.3.4",
    "id": "ASVS_7.3.4",
    "title": _("Verify that time sources are synchronized to the correct time "
  ...
  },
  {
    ...
    "code": "V7.4.1",
    "id": "ASVS_7.4.1",
    "title": _("Verify that a generic message is shown when an unexpected or "
  ...
  },
  {
    ...
    "code": "V7.4.2",
    "id": "ASVS_7.4.2",
    "title": _("Verify that exception handling (or a functional equivalent) "
  ...
  },
  {
    ...
    "code": "V7.4.3",
    "id": "ASVS_7.4.3",
    "title": _("Verify that a \"last resort\" error handler is defined which "
  ...
  },
  {
    ...
    "code": "V8.1.1",
    "id": "ASVS_8.1.1",
    "title": _("Verify the application protects sensitive data from being "
  ...
  },
  {
    ...
    "code": "V8.1.2",
    "id": "ASVS_8.1.2",
    "title": _("Verify that all cached or temporary copies of sensitive data "
  ...
  },
  {
    ...
    "code": "V8.1.3",
    "id": "ASVS_8.1.3",
    "title": _("Verify the application minimizes the number of parameters in "
  ...
  },
  {
    ...
    "code": "V8.1.4",
    "id": "ASVS_8.1.4",
    "title": _("Verify the application can detect and alert on abnormal "
  ...
  },
  {
    ...
    "code": "V8.1.5",
    "id": "ASVS_8.1.5",
    "title": _("Verify that regular backups of important data are performed "
  ...
  },
  {
    ...
    "code": "V8.1.6",
    "id": "ASVS_8.1.6",
    "title": _("Verify that backups are stored securely to prevent data from "
  ...
  },
  {
    ...
    "code": "V8.2.1",
    "id": "ASVS_8.2.1",
    "title": _("Verify the application sets sufficient anti-caching headers "
  ...
  },
  {
    ...
    "code": "V8.2.2",
    "id": "ASVS_8.2.2",
    "title": _("Verify that data stored in browser storage (such as HTML5 "
  ...
  },
  {
    ...
    "code": "V8.2.3",
    "id": "ASVS_8.2.3",
    "title": _("Verify that authenticated data is cleared from client "
  ...
  },
  {
    ...
    "code": "V8.3.1",
    "id": "ASVS_8.3.1",
    "title": _("Verify that sensitive data is sent to the server in the HTTP "
  ...
  },
  {
    ...
    "code": "V8.3.2",
    "id": "ASVS_8.3.2",
    "title": _("Verify that users have a method to remove or export their "
               "data on demand."),
    "active": True,
  },
  {
    ...
    "code": "V8.3.3",
    "id": "ASVS_8.3.3",
    "title": _("Verify that users are provided clear language regarding "
  ...
  },
  {
    ...
    "code": "V8.3.4",
    "id": "ASVS_8.3.4",
    "title": _("Verify that all sensitive data created and processed by the "
  ...
  },
  {
    ...
    "code": "V8.3.5",
    "id": "ASVS_8.3.5",
    "title": _("Verify accessing sensitive data is audited (without logging "
  ...
  },
  {
    ...
    "code": "V8.3.6",
    "id": "ASVS_8.3.6",
    "title": _("Verify that sensitive information contained in memory is "
  ...
  },
  {
    ...
    "code": "V8.3.7",
    "id": "ASVS_8.3.7",
    "title": _("Verify that sensitive or private information that is required "
  ...
  },
  {
    ...
    "code": "V8.3.8",
    "id": "ASVS_8.3.8",
    "title": _("Verify that sensitive personal information is subject to data "
  ...
  },
  {
    ...
    "code": "V9.1.1",
    "id": "ASVS_9.1.1",
    "title": _("Verify that secured TLS is used for all client connectivity, "
  ...
  },
  {
    ...
    "code": "V9.1.2",
    "id": "ASVS_9.1.2",
    "title": _("Verify using online or up to date TLS testing tools that only "
  ...
  },
  {
    ...
    "code": "V9.1.3",
    "id": "ASVS_9.1.3",
    "title": _("Verify that old versions of SSL and TLS protocols, "
  ...
  },
  {
    ...
    "code": "V9.2.1",
    "id": "ASVS_9.2.1",
    "title": _("Verify that connections to and from the server use trusted "
  ...
  },
  {
    ...
    "code": "V9.2.2",
    "id": "ASVS_9.2.2",
    "title": _("Verify that encrypted communications such as TLS is used for "
  ...
  },
  {
    "code": "V9.2.3",
    "id": "ASVS_9.2.3",
    "title": _("Verify that all encrypted connections to external systems "
  ...
  },
  {
    "code": "V9.2.4",
    "id": "ASVS_9.2.4",
    "title": _("Verify that proper certification revocation, such as Online "
