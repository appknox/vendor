...
data = [
  ...
  },
  {
      "id": "MSTG_1.2",
      "code": "MSTG-ARCH-2",
      "title": _("Security controls are never enforced only on the client "
  ...
  },
  {
      "id": "MSTG_1.3",
      "code": "MSTG-ARCH-3",
      "title": _("A high-level architecture for the mobile app and all "
  ...
  },
  {
      "id": "MSTG_1.4",
      "code": "MSTG-ARCH-4",
      "title": _("Data considered sensitive in the context of the mobile app "
  ...
  },
  {
      "id": "MSTG_1.5",
      "code": "MSTG-ARCH-5",
      "title": _("All app components are defined in terms of the business "
  ...
  },
  {
      "id": "MSTG_1.6",
      "code": "MSTG-ARCH-6",
      "title": _("A threat model for the mobile app and the associated remote "
  ...
  },
  {
      "id": "MSTG_1.8",
      "code": "MSTG-ARCH-8",
      "title": _("There is an explicit policy for how cryptographic keys "
  ...
  },
  {
      "id": "MSTG_1.10",
      "code": "MSTG-ARCH-10",
      "title": _("Security is addressed within all parts of the software "
  ...
  },
  {
      "id": "MSTG_1.11",
      "code": "MSTG-ARCH-11",
      "title": _("A responsible disclosure policy is in place and effectively "
                 "applied."),
      "active": True,
  },
  {
  ...
  # 0x07-v2-data_storage_and_privacy_requirements
  {
      "id": "MSTG_2.1",
      "code": "MSTG-STORAGE-1",
      "title": _("System credential storage facilities need to be used to "
  ...
  },
  {
      "id": "MSTG_2.2",
      "code": "MSTG-STORAGE-2",
      "title": _("No sensitive data should be stored outside of the app "
  ...
  },
  {
      "id": "MSTG_2.4",
      "code": "MSTG-STORAGE-4",
      "title": _("No sensitive data is shared with third parties unless it is "
  ...
  },
  {
      "id": "MSTG_2.5",
      "code": "MSTG-STORAGE-5",
      "title": _("The keyboard cache is disabled on text inputs that process "
                 "sensitive data."),
      "active": True,
  },
  {
  ...
  },
  {
      "id": "MSTG_2.7",
      "code": "MSTG-STORAGE-7",
      "title": _("No sensitive data, such as passwords or pins, is exposed "
  ...
  },
  {
      "id": "MSTG_2.8",
      "code": "MSTG-STORAGE-8",
      "title": _("No sensitive data is included in backups generated by the "
  ...
  },
  {
      "id": "MSTG_2.9",
      "code": "MSTG-STORAGE-9",
      "title": _("The app removes sensitive data from views when moved to the "
                 "background."),
      "active": True,
  },
  {
      ...
      "title": _("The app does not hold sensitive data in memory longer than "
  ...
  },
  {
      ...
      "title": _("The app enforces a minimum device-access-security policy, "
  ...
  },
  {
      ...
      "title": _("The app educates the user about the types of personally "
  ...
  },
  {
      ...
      "title": _("No sensitive data should be stored locally on the mobile "
  ...
  },
  {
      ...
      "title": _("If sensitive data is still required to be stored locally, it "
  ...
  },
  {
      ...
      "title": _("The app’s local storage should be wiped after an excessive "
  ...
  # 0x08-v3-cryptography_verification_requirements
  {
      "id": "MSTG_3.1",
      "code": "MSTG-CRYPTO-1",
      "title": _("The app does not rely on symmetric cryptography with "
  ...
  },
  {
      "id": "MSTG_3.2",
      "code": "MSTG-CRYPTO-2",
      "title": _("The app uses proven implementations of cryptographic "
                 "primitives."),
      "active": True,
  },
  {
      "id": "MSTG_3.3",
      "code": "MSTG-CRYPTO-3",
      "title": _("The app uses cryptographic primitives that are appropriate "
  ...
  },
  {
      "id": "MSTG_3.4",
      "code": "MSTG-CRYPTO-4",
      "title": _("The app does not use cryptographic protocols or algorithms "
  ...
  },
  {
      "id": "MSTG_3.5",
      "code": "MSTG-CRYPTO-5",
      "title": _("TThe app doesn't re-use the same cryptographic key for "
                 "multiple purposes."),
      "active": True,
  },
  {
      "id": "MSTG_3.6",
      "code": "MSTG-CRYPTO-6",
      "title": _("All random values are generated using a sufficiently secure "
  ...
  # 0x09-v4-authentication_and_session_management_requirements
  {
      "id": "MSTG_4.1",
      "code": "MSTG-AUTH-1",
      "title": _("If the app provides users access to a remote service, some "
  ...
  },
  {
      "id": "MSTG_4.2",
      "code": "MSTG-AUTH-2",
      "title": _("If stateful session management is used, the remote endpoint "
  ...
  },
  {
      "id": "MSTG_4.3",
      "code": "MSTG-AUTH-3",
      "title": _("If stateless token-based authentication is used, the server "
  ...
  },
  {
      "id": "MSTG_4.4",
      "code": "MSTG-AUTH-4",
      "title": _("The remote endpoint terminates the existing session when "
                 "the user logs out."),
      "active": True,
  },
  {
      "id": "MSTG_4.5",
      "code": "MSTG-AUTH-5",
      "title": _("A password policy exists and is enforced at the remote "
                 "endpoint."),
      "active": True,
  },
  {
      "id": "MSTG_4.6",
      "code": "MSTG-AUTH-6",
      "title": _("The remote endpoint implements a mechanism to protect "
  ...
  },
  {
      "id": "MSTG_4.7",
      "code": "MSTG-AUTH-7",
      "title": _("Sessions are invalidated at the remote endpoint after a "
  ...
  },
  {
      "id": "MSTG_4.8",
      "code": "MSTG-AUTH-8",
      "title": _("Biometric authentication, if any, is not event-bound (i.e. "
  ...
  },
  {
      "id": "MSTG_4.9",
      "code": "MSTG-AUTH-9",
      "title": _("A second factor of authentication exists at the remote "
  ...
  },
  {
      "id": "MSTG_4.11",
      "code": "MSTG-AUTH-11",
      "title": _("The app informs the user of all sensitive activities with "
  ...
  },
  {
      "id": "MSTG_4.12",
      "code": "MSTG-AUTH-12",
      "title": _("Authorization models should be defined and enforced at the "
                 "remote endpoint."),
      "active": True,
  },
  ...
  # 0x10-v5-network_communication_requirements
  {
      "id": "MSTG_5.1",
      "code": "MSTG-NETWORK-1",
      "title": _("Data is encrypted on the network using TLS. The secure "
  ...
  },
  {
      "id": "MSTG_5.2",
      "code": "MSTG-NETWORK-2",
      "title": _("The TLS settings are in line with current best practices, "
  ...
  },
  {
      "id": "MSTG_5.3",
      "code": "MSTG-NETWORK-3",
      "title": _("The app verifies the X.509 certificate of the remote "
  ...
  },
  {
      "id": "MSTG_5.4",
      "code": "MSTG-NETWORK-4",
      "title": _("The app either uses its own certificate store, or pins the "
  ...
  },
  {
      "id": "MSTG_5.5",
      "code": "MSTG-NETWORK-5",
      "title": _("The app doesn't rely on a single insecure communication "
  ...
  },
  {
      "id": "MSTG_5.6",
      "code": "MSTG-NETWORK-6",
      "title": _("The app only depends on up-to-date connectivity and "
                 "security libraries."),
      "active": True,
  },
  ...
  # 0x11-v6-interaction_with_the_environment
  {
      ...
      "title": _("The app only requests the minimum set of permissions "
                 "necessary."),
      "active": True,
  },
  {
      ...
      "title": _("All inputs from external sources and the user are validated "
  ...
  },
  {
      ...
      "title": _("The app does not export sensitive functionality via custom "
  ...
  },
  {
      ...
      "title": _("The app does not export sensitive functionality through IPC "
  ...
  },
  {
      ...
      "title": _("JavaScript is disabled in WebViews unless explicitly "
                 "required."),
      "active": True,
  },
  {
      ...
      "title": _("WebViews are configured to allow only the minimum set of "
  ...
  },
  {
      ...
      "title": _("If native methods of the app are exposed to a WebView, "
  ...
  },
  {
      ...
      "title": _("Object deserialization, if any, is implemented using safe "
                 "serialization APIs."),
      "active": True,
  },
  {
      ...
      "title": _("The app protects itself against screen overlay attacks. "
                 "(Android only)"),
      "active": True,
  },
  {
      ...
      "title": _("A WebView's cache, storage, and loaded resources "
  ...
  },
  {
      "id": "MSTG_6.11",
      "code": "MSTG-PLATFORM-11",
      "title": _("Verify that the app prevents usage of custom third-party "
  ...
  # 0x12-v7-code_quality_and_build_setting_requirements
  {
      "id": "MSTG_7.1",
      "code": "MSTG-CODE-1",
      "title": _("The app is signed and provisioned with a valid certificate, "
  ...
  },
  {
      "id": "MSTG_7.2",
      "code": "MSTG-CODE-2",
      "title": _("The app has been built in release mode, with settings "
  ...
  },
  {
      "id": "MSTG_7.4",
      "code": "MSTG-CODE-4",
      "title": _("Debugging code and developer assistance code (e.g. test "
  ...
  },
  {
      "id": "MSTG_7.5",
      "code": "MSTG-CODE-5",
      "title": _("All third party components used by the mobile app, such as "
  ...
  },
  {
      "id": "MSTG_7.7",
      "code": "MSTG-CODE-7",
      "title": _("Error handling logic in security controls denies access by "
                 "default."),
      "active": True,
  },
  {
      "id": "MSTG_7.8",
      "code": "MSTG-CODE-8",
      "title": _("In unmanaged code, memory is allocated, freed and used "
                 "securely."),
      "active": True,
  },
  {
      "id": "MSTG_7.9",
      "code": "MSTG-CODE-9",
      "title": _("Free security features offered by the toolchain, such as "
  ...
  # 0x15-v8-resiliency_against_reverse_engineering_requirements
  {
      ...
      "title": _("The app detects, and responds to, the presence of a rooted "
  ...
  },
  {
      ...
      "title": _("The app prevents debugging and/or detects, and responds to, "
  ...
  },
  {
      ...
      "title": _("The app detects, and responds to, tampering with executable "
  ...
  },
  {
      ...
      "title": _("The app detects, and responds to, the presence of widely "
  ...
  },
  {
      ...
      "title": _("The app detects, and responds to, tampering the code and "
  ...
  },
  {
      "id": "MSTG_8.7",
      "code": "MSTG-RESILIENCE-1",
      "title": _("The app implements multiple mechanisms in each defense "
  ...
  },
  {
      ...
      "title": _("The detection mechanisms trigger responses of different "
  ...
  },
  {
      ...
      "title": _("Obfuscation is applied to programmatic defenses, which in "
  ...
  },
  {
      ...
      "title": _("The app implements a 'device binding' functionality using a "
  ...
  },
  {
      ...
      "title": _("All executable files and libraries belonging to the app are "
  ...
  },
  {
      ...
      "title": _("If the goal of obfuscation is to protect sensitive "
  ...
  },
  {
      ...
      "title": _("As a defense in depth, next to having solid hardening of "
